...
def resources(repo: Path, home: Path, host: str) -> list[tuple[Path, Path, str]]:
    ...
    if host == "pi":
        return [
            ...
            (repo / "pi/agents/planner.md", home / "agents/planner.md", "copy"),
            (repo / "pi/agents/reviewer.md", home / "agents/reviewer.md", "copy"),
            (repo / "pi/agents/scout.md", home / "agents/scout.md", "copy"),
            (repo / "pi/agents/worker.md", home / "agents/worker.md", "copy"),
            ...
            (repo / "pi/extensions/subagent/index.ts",
