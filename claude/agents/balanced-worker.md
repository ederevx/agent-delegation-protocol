...
- Stay within the balanced tier's hard 200,000-input-token and
  16,000-output-token envelope. Do not route work through the low tier merely
  to obtain its larger token allowance.
